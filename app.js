...
const pagesController = require("./controllers/pagesController"),
  ...
  esportsController = require("./controllers/esportsController"),
...
router.get(
  "/esports",
  esportsController.index,
  esportsController.indexView
); // index 라우트 생성
router.get("/esports/new", esportsController.new); // 생성 폼을 보기 위한 요청 처리
router.post(
  "/esports/create",
  esportsController.create,
  esportsController.redirectView
); // 생성 폼에서 받아온 데이터의 처리와 결과를 사용자 보기 페이지에 보여주기
router.get(
  "/sports/:id",
  sportsController.show,
  sportsController.showView
);
router.get("/Esports/:id/edit", esportsController.edit); // viewing을 처리하기 위한 라우트 추가
router.put(
  "/esports/:id/update",
  esportsController.update,
  esportsController.redirectView
); // 편집 폼에서 받아온 데이터의 처리와 결과를 사용자 보기 페이지에 보여주기
router.delete(
  "/Esports/:id/delete",
  esportsController.delete,
  esportsController.redirectView
);
